...
$form_submissions = $HELPER->getAll();
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header" id="scrol-top">
                ...
                <h1>
                    ...
                    Manage Invoice/Booking Submissions
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Invoice/Booking Submissions</li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <table class="table table-bordered table-hover" width="100%" id="invoices-list">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php foreach ($form_submissions as $detail) {
