                                    ...
                                    <div class="contact-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-xs-12 mobile-marg">
                                                <div class="alert alert-info text-justify" id="" style="margin: 0px 0px 15px 0  px;">
                                                    LEVEL 1 HOTEL, CURRENTLY PERMITTED TO ACCEPT BOOKINGS FROM FOREIGN PASSPORT HOLDERS ONLY.
                                                    <br />
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane booking-box bk-box" id="final-booking">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12" style="margin-bottom: 10px;">
                                                                ...
                                                                <label class="checkbox-container pull-right font-red">LEVEL 1 HOTEL, CURRENTLY PERMITTED TO ACCEPT BOOKINGS FROM FOREIGN PASSPORT HOLDERS ONLY</label>
                                            ...
                                            <div class="booking-price-wrap">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6 booking-price cart-desktop" id="cart">
                                                    ...
                                                    <div class="price-box-container">
                                                        ...
                                                        <b>Accommodation: </b><br />US$ <span id="cart-rooms-price">0.00</span> <span class="strike-price"><b>US$ <span id="cart-price">0.00</span></b></span>
                                                        <hr style="margin-bottom:-6px;" />

                                                        <span class="save-price"><b>You will save: US$ <span id="cart-save-price">0.00</span></b></span>
                                                        <hr style="margin-top:-4px;" />

                                                        <div style="display: none;" id="hide-extrabeds"><b>Extra Beds: </b><br />US$ <span id="cart-extrabeds">0.00</span>
                                                            <hr />
                                                        </div>

                                                        <div style="display: none;" id="hide-supplement"><b>Child Supplement: </b><br />US$ <span id="cart-supplement">0.00</span>
                                                            <hr />
                                                        </div>

                                                        <b>Total Amount: </b><br />US$ <span id="cart-subtotal">0.00</span>
                                                        <hr />
