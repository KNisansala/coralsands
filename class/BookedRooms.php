...
class BookedRooms
{
    ...
    public function create($date, $room, $roomtype)
    {
        ...
        $query = "INSERT INTO `booked_rooms` (`date`,`room_type`,`booked_rooms`) VALUES  ('" . mysql_real_escape_string($date) . "','" . mysql_real_escape_string($roomtype) . "','" . mysql_real_escape_string($room) . "')";
    ...
    public static function getByDateAndRoomType($date, $roomtype)
    {
        ...
        $db = new DB();
        $query = "SELECT * FROM `booked_rooms` WHERE date = ' " . mysql_real_escape_string($date) . " ' AND room_type = ' " . mysql_real_escape_string($roomtype) . " ' ";
    ...
    public function getSubBookedByDate($date, $sub_id)
    {
        ...
        $query = "SELECT * FROM `booked_rooms` WHERE (`room_type` = '" . mysql_real_escape_string($sub_id) . "') AND (`date` = '" . mysql_real_escape_string($date) . "') ";
    ...
    public function updateAvailable($subType, $date, $setAv)
    {
        ...
        $db = new DB();
        $query = "UPDATE `booked_rooms` SET "
            . "booked_rooms=booked_rooms+" . mysql_real_escape_string($setAv) . " "
            . " WHERE (`room_type` = '" . mysql_real_escape_string($subType) . "') AND (`date` = '" . mysql_real_escape_string($date) . "') ";
    ...
    public function setAvailable($subType, $date, $setAv)
    {
        ...
        $query = "INSERT INTO `booked_rooms` (`date`,`room_type`,`booked_rooms`) VALUES  ('" . mysql_real_escape_string($date) . "','" . mysql_real_escape_string($subType) . "','" . mysql_real_escape_string($setAv) . "')";
