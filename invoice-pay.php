                                                    ...
                                                    <div style="text-align: center; margin: 35px 0px;">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 col-md-offset-5 btns" style="float: left; text-align: left;">
                                                                    ...
                                                                    <button type="submit" id="btnPay" name="btnPay" act="<?php echo $act; ?>" class="btn btn-danger">PAY NOW</button>
                                                        ...
                                                        <form id="invoice-pay" action="payments/PHP_VPC_3Party_Order_DO.php" method="post" accept-charset="UTF-8">
                                                            ...
                                                            <input type="hidden" name="vpc_ReturnURL" size="65" value="https://<?php echo str_replace("www.", "", $_SERVER['HTTP_HOST']); ?>/invoice_response.php" maxlength="250" />
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#btnPay', function(e) {
            ...
            $.ajax({
                ...
                url: "contact-form/captchacode.php",
